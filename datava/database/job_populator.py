...
data = pd.read_table(r'./job_populator_files/joblistings.merged.parsed.unique.grpbyyear.2016.tsv', sep='\t')
onet = pd.read_table(r'./job_populator_files/onet_hierarchy.txt')
onet_minor = pd.read_table(r'./job_populator_files/onet_hierarchy_minor.txt')
onet_broad = pd.read_table(r'./job_populator_files/onet_hierarchy_broad.txt')
onet_detailed = pd.read_table(r'./job_populator_files/onet_hierarchy_detailed.txt')
